...
from zmq.rpc.simplerpc import AsyncRPCServiceProxy
...
if __name__ == '__main__':
    ...
    echo = AsyncRPCServiceProxy(serializer=jsonapi.dumps,deserializer=jsonapi.loads)
    echo.connect('tcp://127.0.0.1:5555')
    echo.echo(print_result, "Hi there")
